...
echo "how much silence ends a frame:"
g++ $F -I ../stubs rx_idle_test.cpp -o rx_idle_test
./rx_idle_test
echo
...
echo "the command slot:"
g++ $F command_slot_test.cpp "$SRC/hcp1_frame.cpp" "$SRC/hcp1_codec.cpp" \
       "$SRC/hcp2_frame.cpp" "$SRC/hcp2_codec.cpp" \
       "$SRC/hcp_state.cpp" "$SRC/hcp_events.cpp" -o command_slot_test
./command_slot_test
echo

echo "both tasks at once:"
g++ $F two_task_test.cpp "$SRC/hcp2_frame.cpp" "$SRC/hcp2_codec.cpp" \
       "$SRC/hcp_state.cpp" "$SRC/hcp_events.cpp" -o two_task_test
./two_task_test
echo

echo "the same under the thread sanitizer:"
g++ $F -fsanitize=thread -g two_task_test.cpp "$SRC/hcp2_frame.cpp" "$SRC/hcp2_codec.cpp" \
       "$SRC/hcp_state.cpp" "$SRC/hcp_events.cpp" -o two_task_test_tsan
./two_task_test_tsan
echo
...
rm -f event_ring_test event_ring_test_tsan hcp1_frame_test hcp1_codec_test rx_idle_test command_slot_test two_task_test two_task_test_tsan
