// The port and the task the newer bus runs on.
//
// Everything that decides what to answer is in hcp2_codec, which has no port,
// no clock and no thread. This is the other half: it owns the UART, reads the
